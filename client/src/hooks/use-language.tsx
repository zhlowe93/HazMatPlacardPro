...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "input.subsidiaryClass": "Subsidiary Hazard Class (if any)",
    "input.subsidiaryClass.placeholder": "None",
    "input.subsidiaryClass.description": "Check shipping papers for a class in parentheses, e.g., 6.1 (4.3). Required for correct placarding.",
    "subsidiary.none": "None",
    "quick.subsidiary": "Subsidiary Hazard",
  ...
  es: {
    ...
    "input.subsidiaryClass": "Clase de Peligro Subsidiaria (si aplica)",
    "input.subsidiaryClass.placeholder": "Ninguna",
    "input.subsidiaryClass.description": "Verifique en los papeles de envio la clase entre parentesis, ej., 6.1 (4.3). Necesario para letreros correctos.",
    "subsidiary.none": "Ninguna",
    "quick.subsidiary": "Peligro Subsidiario",
